...
// Only apply Sentry config in CI/CD to avoid local build issues with temp directories
// Local builds will still work, but source maps won't be uploaded (they'll be uploaded in Vercel)
