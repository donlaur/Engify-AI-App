    ...
    <MainLayout>
      ...
      <section className="container py-24 md:py-32">
        <div className="mx-auto max-w-3xl space-y-8 text-center">
          ...
          <p className="mb-2 text-lg italic text-muted-foreground">
            Engineer + Amplify +{' '}
            <span className="font-semibold text-primary">AI</span> = Engify.ai
          </p>
          <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
            Transform engineers into AI power users. Master prompt engineering
            with {totalPrompts} expert-curated prompts, 15 battle-tested
            patterns, and gamified learning. Amplify your team&apos;s
            capabilities—engify your workflow.
          </p>
