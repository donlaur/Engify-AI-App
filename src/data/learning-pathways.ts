...
export const learningPathways: LearningPathway[] = [
  {
    ...
    description:
      'A guided pathway for engineering managers and directors to develop a robust AI strategy for their teams.',
    steps: [
      {
        id: 1,
      ...
      },
      {
        ...
        description:
          "Now, apply your strategic thinking. Use the 'Technical Debt Strategist' to build a business case for a real-world problem.",
        actionText: 'Go to Workbench',
        type: 'workbench',
  ...
  },
  {
    ...
    description:
      'A curated list of cost-effective, industry-recognized courses to build a strong foundation in AI and cloud engineering.',
    steps: [
      {
        id: 1,
      ...
      },
      {
        ...
        description:
          "Created by Andrew Ng, this is a classic, highly-regarded course that explains AI from a strategic, business-oriented perspective. Essential for leaders, PMs, and any engineer who wants to understand the 'why' behind AI.",
        actionText: 'Explore on Coursera',
        type: 'external_link',
      ...
      },
      {
        ...
        description:
          'A foundational understanding of cloud computing is essential for working with AI at scale. This certification from AWS provides a comprehensive overview of cloud concepts, services, and security. Similar certifications are available for GCP and Azure.',
      ...
      },
      {
        ...
        description:
          "This certification is a great entry point into Microsoft's AI ecosystem. It covers fundamental concepts of machine learning and AI workloads on Azure, making it a valuable credential in a multi-cloud world.",
  ...
  },
  {
    ...
    description:
      'Learn the fundamental techniques of writing effective prompts to get better results from any AI model.',
    steps: [
      {
        id: 1,
        title: 'Understand the Model Landscape',
        description:
          "Start by reading Ethan Mollick's guide to understand when to use free vs. advanced models. This context is crucial before writing any prompt.",
        actionText: 'Read Article',
        type: 'article',
      ...
      },
      {
        ...
        description:
          'A great prompt has a clear structure. Use the C.R.A.F.T.E.D. framework to learn how to provide clear context, roles, and actions to the AI.',
        actionText: 'Use Prompt Playbook',
        type: 'playbook',
      ...
      },
      {
        ...
        description:
          "Explore powerful techniques like the two-step 'Plan + Execute' method and giving the AI a persona to dramatically improve output quality.",
        actionText: 'Read Article',
        type: 'article',
      ...
      },
      {
        ...
        description:
          'Go to the Prompt Lab in the Workbench. Try using the C.R.A.F.T.E.D. framework and the two-step method to write a prompt for a task you do every day.',
        actionText: 'Go to Workbench',
        type: 'workbench',
        targetId: 'prompt-lab',
      },
