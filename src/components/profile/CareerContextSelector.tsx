...
import { CareerLevel, CompanySize, CareerGoal, UserCareerContext } from '@/lib/types/user';
...
export function CareerContextSelector({
  ...
  const [level, setLevel] = useState<CareerLevel>(initialContext?.level || 'mid');
  const [companySize, setCompanySize] = useState<CompanySize>(initialContext?.companySize || 'mid');
  const [careerGoal, setCareerGoal] = useState<CareerGoal | undefined>(initialContext?.careerGoal);
  const [targetLevel, setTargetLevel] = useState<CareerLevel | undefined>(initialContext?.targetLevel);
  ...
  return (
    <Card className="w-full max-w-2xl">
      <CardHeader>
        ...
        <CardDescription>
          This helps us personalize your learning experience and recommend the right patterns for your level
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Career Level */}
        <div className="space-y-3">
          <Label className="text-base font-semibold">What's your current level?</Label>
          <RadioGroup value={level} onValueChange={(value) => setLevel(value as CareerLevel)}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="junior" id="junior" />
              <Label htmlFor="junior" className="font-normal cursor-pointer">
                <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="senior" className="font-normal cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">5-8 years experience</div>
                </div>
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="staff" className="font-normal cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">8-12 years experience</div>
                </div>
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="principal" className="font-normal cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">12+ years experience</div>
                </div>
              </Label>
            </div>
          </RadioGroup>
        ...
        <div className="space-y-3">
          ...
          <RadioGroup value={companySize} onValueChange={(value) => setCompanySize(value as CompanySize)}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="mid-size" className="font-normal cursor-pointer">
                <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="enterprise" className="font-normal cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">500+ employees</div>
                </div>
              </Label>
            </div>
          </RadioGroup>
        ...
        <div className="space-y-3">
          ...
          <Select value={careerGoal} onValueChange={(value) => setCareerGoal(value as CareerGoal)}>
              ...
              <SelectItem value="promotion">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Level up in my career</div>
                  </div>
                </div>
              </SelectItem>
              <SelectItem value="skill-building">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Improve at my current level</div>
                  </div>
                </div>
              </SelectItem>
              <SelectItem value="job-search">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Looking for new opportunities</div>
                  </div>
                </div>
              </SelectItem>
            </SelectContent>
        ...
        {careerGoal === 'promotion' && (
          <div className="space-y-3">
            ...
            <Select value={targetLevel} onValueChange={(value) => setTargetLevel(value as CareerLevel)}>
              <SelectTrigger id="target">
                <SelectValue placeholder="Select target level..." />
              </SelectTrigger>
              <SelectContent>
                {level !== 'mid' && <SelectItem value="mid">Mid-Level (L3)</SelectItem>}
                {level !== 'senior' && level !== 'mid' && <SelectItem value="senior">Senior (L4)</SelectItem>}
                {level !== 'staff' && level !== 'senior' && level !== 'mid' && (
                  <SelectItem value="staff">Staff (L5)</SelectItem>
                )}
                {level !== 'principal' && <SelectItem value="principal">Principal+ (L6+)</SelectItem>}
              </SelectContent>
            </Select>
          </div>
        )}
        ...
        <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg space-y-2">
          <div className="flex items-start gap-2">
            <Icons.sparkles className="h-5 w-5 text-blue-600 mt-0.5" />
