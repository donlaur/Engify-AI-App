...
export const SLUG_TO_DB_ROLE: Record<string, string> = {
  ...
  designers: 'designer',
  'c-level': 'c-level',
  'engineering-directors': 'engineering-director',
  'product-directors': 'product-director',
  'vp-engineering': 'vp-engineering',
  'vp-product': 'vp-product',
  ctos: 'cto',
};
...
> = {
  ...
  'engineering-director': {
    ...
    description:
      'Leadership prompts for Engineering Directors focusing on team management, technical strategy, skip-level 1-on-1s, and eNPS improvement.',
    icon: 'briefcase',
  },
  'product-director': {
    title: 'Product Directors',
    description:
      'Leadership prompts for Product Directors focusing on product strategy, team management, customer impact, and product culture.',
    icon: 'target',
  },
  'vp-engineering': {
    title: 'VP of Engineering',
    description:
      'Strategic prompts for VPs of Engineering focusing on scaling organizations, executive communication, and aligning engineering with business goals.',
    icon: 'briefcase',
  },
  'vp-product': {
    title: 'VP of Product',
    description:
      'Strategic prompts for VPs of Product focusing on product vision, scaling product orgs, and aligning product strategy with business goals.',
    icon: 'target',
  },
  cto: {
    title: 'CTO',
    description:
      'Strategic prompts for CTOs focusing on technical strategy, architecture decisions, risk management, and executive leadership.',
    icon: 'briefcase',
  },
};
