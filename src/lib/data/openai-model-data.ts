...
export const OPENAI_MODEL_DATA: Record<string, {
  ...
  'gpt-5.1': {
    id: 'gpt-5.1',
    displayName: 'GPT-5.1',
    tagline: 'Enhanced version of GPT-5 with improved reasoning and performance.',
    description: 'GPT-5.1 is an enhanced version of GPT-5 with improved reasoning capabilities, better performance, and expanded context understanding.',
    isDefault: true,
    performanceMetrics: {
      reasoning: 'higher',
      speed: 'medium',
    ...
    knowledgeCutoff: 'Dec 15, 2024',
    pricing: {
      costPer1kInputTokens: 1.50 / 1000, // $1.50 per 1M
      costPer1kCachedInputTokens: 0.15 / 1000, // $0.15 per 1M
      costPer1kOutputTokens: 12.00 / 1000, // $12 per 1M
      pricingUnit: 'tokens',
    },
    modalities: {
      text: 'input-output',
    ...
    snapshots: [
      { id: 'gpt-5.1', pointsTo: 'gpt-5.1-2025-12-15', isAlias: true, isSnapshot: false },
      { id: 'gpt-5.1-2025-12-15', pointsTo: 'gpt-5.1-2025-12-15', isAlias: false, isSnapshot: true },
    ],
    rateLimits: [
      { tier: 'Free', rpm: undefined, tpm: undefined, batchQueueLimit: undefined },
      { tier: 'Tier 1', rpm: 500, tpm: 500000, batchQueueLimit: 1500000 },
