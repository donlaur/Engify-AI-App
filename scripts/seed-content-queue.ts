...
const QUEUE_ITEMS = [
  ...
  // Batch 5: WSJF Spokes (for WSJF landing page)
  {
    title: 'What is WSJF? Complete Guide to Weighted Shortest Job First',
    contentType: 'guide',
    description: 'Comprehensive introduction to WSJF prioritization framework',
    keywords: ['WSJF', 'Weighted Shortest Job First', 'SAFe prioritization', 'agile prioritization'],
  ...
  {
    title: 'WSJF Formula Explained: How to Calculate Cost of Delay Divided by Job Size',
    contentType: 'tutorial',
    description: 'Step-by-step guide to the WSJF formula with examples',
    keywords: ['WSJF formula', 'WSJF calculation', 'cost of delay', 'job size', 'WSJF example'],
    targetWordCount: 2000,
    priority: 'high',
    batch: 'wsjf-spokes',
    source: 'ai-research',
  ...
  {
    title: 'WSJF vs Story Points: When to Use Each Prioritization Method',
    contentType: 'comparison',
    description: 'Compare WSJF with story points and other prioritization methods',
    keywords: ['WSJF vs story points', 'agile prioritization', 'backlog prioritization', 'SAFe vs Scrum'],
    targetWordCount: 2000,
    priority: 'medium',
    batch: 'wsjf-spokes',
    source: 'ai-research',
  ...
  {
    title: 'Cost of Delay: Understanding the Key Component of WSJF',
    contentType: 'tutorial',
    description: 'Deep dive into Cost of Delay and its three components',
    keywords: ['cost of delay', 'WSJF', 'user value', 'time criticality', 'risk reduction'],
    targetWordCount: 2000,
    priority: 'medium',
    batch: 'wsjf-spokes',
    source: 'ai-research',
  ...
  {
    title: 'WSJF in Practice: Real-World Examples and Case Studies',
    contentType: 'case-study',
    description: 'How teams use WSJF to prioritize backlogs effectively',
    keywords: ['WSJF example', 'WSJF case study', 'backlog prioritization example', 'SAFe implementation'],
    targetWordCount: 2500,
    priority: 'medium',
    batch: 'wsjf-spokes',
    source: 'ai-research',
  ...
  {
    title: 'Common WSJF Mistakes and How to Avoid Them',
    contentType: 'best-practices',
    description: 'Learn the pitfalls teams face when implementing WSJF',
    keywords: ['WSJF mistakes', 'WSJF best practices', 'WSJF tips', 'prioritization errors'],
  ...
  {
    title: 'AI-Enhanced WSJF: Using AI to Improve Prioritization Accuracy',
    contentType: 'guide',
    description: 'How AI can help teams make better WSJF estimates',
    keywords: ['AI WSJF', 'AI prioritization', 'AI backlog', 'automated prioritization'],
    targetWordCount: 2000,
    priority: 'high',
    batch: 'wsjf-spokes',
    source: 'ai-research',
  ...
  {
    title: 'WSJF for Portfolio Management: Prioritizing Features Across Teams',
    contentType: 'guide',
    description: 'Using WSJF at the portfolio level in SAFe',
    keywords: ['WSJF portfolio', 'SAFe portfolio', 'feature prioritization', 'enterprise agile'],
